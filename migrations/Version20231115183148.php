 ...
 */
final class Version20231115183148 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD categorie VARCHAR(255) NOT NULL, CHANGE image image VARCHAR(255) NOT NULL, CHANGE description description VARCHAR(255) NOT NULL, CHANGE idCategorie idCategorie INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit DROP categorie, CHANGE image image VARCHAR(250) NOT NULL, CHANGE description description VARCHAR(250) NOT NULL, CHANGE idCategorie idCategorie INT NOT NULL');
