 ...
 */
final class Version20231108142849 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande ADD CONSTRAINT FK_6EEAA67DFE6E88D7 FOREIGN KEY (idUser) REFERENCES user (Id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE produit MODIFY id_prd INT NOT NULL');
        $this->addSql('DROP INDEX `primary` ON produit');
        $this->addSql('ALTER TABLE produit DROP FOREIGN KEY produit_ibfk_1');
        $this->addSql('ALTER TABLE produit CHANGE image image VARCHAR(255) NOT NULL, CHANGE description description VARCHAR(255) NOT NULL, CHANGE categorie categorie VARCHAR(255) NOT NULL, CHANGE idCategorie idCategorie INT DEFAULT NULL, CHANGE id_prd id INT AUTO_INCREMENT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit CHANGE image image VARCHAR(250) NOT NULL, CHANGE description description VARCHAR(250) NOT NULL, CHANGE categorie categorie VARCHAR(250) NOT NULL, CHANGE idCategorie idCategorie INT NOT NULL, CHANGE id id_prd INT AUTO_INCREMENT NOT NULL');
        $this->addSql('ALTER TABLE produit ADD PRIMARY KEY (id_prd)');
        $this->addSql('DROP INDEX idx_29a5ec27b597fd62 ON produit');
        $this->addSql('CREATE INDEX idCategorie ON produit (idCategorie)');
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT FK_29A5EC27B597FD62 FOREIGN KEY (idCategorie) REFERENCES categorie_magasin (id)');
